...
public class SchoolMain {
	...
	public static void main(String[] args) {
		...
		Student yesl = new Student("예슬", 85, 83, 87, (85+80+87)/3.0);
...
//		yesl.setAvg(100);
		...
		Student donguk = new Student("동욱",90 , 80 , 87,UtillClass.weRound((90+80+87)/3.0,1));
		System.out.println(donguk);
		...
		stuList.add(new Student ("경호",70,92,78));
		...
		// 학생들의 평균을 이용해서
		// 1등. [동욱, 국어: 90, 영어: 86, 수학: 87, 평균: 87.7]
