...
public class NextMain {
	...
	public static void main(String[] args) {
		...
		// syso 내에 객체를 넣게되면, toString() 의 실행결과가
		// 콘솔창에 출력된다.
		...
		// 레벨과 경험치는 1과 0 으로 고정해서 만들어보세요
		// 2명이상 만들어보기
		NextStudent donguk = new NextStudent("동욱",26,1,0);
		NextStudent kyeongho = new NextStudent("경호",28,1,0);
		...
		// 레벨을 이용하여 정렬하기
		// Collection.sort()는 정렬 기준을 모르면 에러가난다
//		Collection.sort(stuList);
		System.out.println("\n==================================================\n");
		// 버블정렬을 이용하여 정렬하기
		// 변수명 한번에 바꾸기 단축키 [ Alt + Shift + R]
		// 레벨순으로 정렬
		// stuList[지혜][동욱][태윤][유정][준하][준호]
