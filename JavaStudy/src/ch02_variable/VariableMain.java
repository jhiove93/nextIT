...
//		System.out.println(strNull.concat("채우기"));
		...
		// 많이 하는 실수
		double result = 10 / 3; //예상 3.3333.... 
		System.out.println(result); // 3.0
		
		// result가 3.333333 으로 출력되도록 바꿔보세요
		double resultA = (double)10 / 3 ;
