...
//		seoyugi[4] = "크리링";
		...
		for(int i = 0 ; i < intArray.length ; i++) {
			...
			// (int)Math.random() *20+1	 -> 0 ~ 10사이의 랜덤 정수 
			// 0, 0.5, 4.5
		...
		// copy의 각 인덱스에, seoyugi 의 각 인덱스 값을 넣어준다
		for(int i =0 ; i < seoyugi.length; i++) {
			copy[i] = seoyugi[i];
		}
		...
		// 참조타입 변수에 대해서는 Call by Reference 동작
		int a = 10;
		int b = a;
